/*
    ...
    along with WMT; if not, write to the Free Software
...
int ArgParse(int argc, char **argv) {
	...
	for(int argcounter=1; argcounter<argc; argcounter++) {
		...
		if(WMT_equalstr(argv[argcounter], "-v")) {
			...
			printf("   -o <path>       Overrides the default output path and filename.\n");
			printf("   --version       Show version and exit.\n");
			printf("   -feh            Open output image with feh. (requires feh installed)\n");
			printf("   -q [--quiet]    No stdout output.\n");
			printf("   -p [--print]    Print info to stdout.\n");
			printf("   -a [--analyze]  Analyzes map.\n");
			printf("   -r [--rebuild]  Attempt to recompile the map to the json format.\n");
			printf("   \n");
			printf("   == image options ==\n");
			printf("   --nowater       Will not draw water. Drawing heghtmap instead.\n");
			printf("   --nobuildings   Will not draw buildings.\n");
			printf("   --nooil         Will not draw oil resources.\n");
			printf("   --nocliff       Will not draw cliff tiles as red.\n");
			printf("   --singlecolorwater Force drawing water as blue.\n");
			printf("   -z <level>      Overrides the default zoom level of the image.\n");
			printf("   --dry           Don\'t draw or output any images.\n");
			printf("   \n");
			printf("   == debug options ==\n");
			printf("   -v              Enables verbose logging level 1. (Useful info)\n");
			printf("   -vv             Enables verbose logging level 2. (A loooot of info)\n");
			printf("   -vvv            Enables verbose logging level 3. (Just spam)\n");
			printf("   -vvvv           Enables verbose logging level 4. (Don\'t use this)\n");
